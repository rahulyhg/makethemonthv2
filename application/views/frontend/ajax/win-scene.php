<section class="win-lose-scene" style="opacity:1">
    <div>
        <h1 class="small bolder white-text"><?php echo $this->lang->line('win-header'); ?></h1>

        <h3 class="white-text"><?php echo $this->lang->line('win-text'); ?><br><span><?php echo $this->lang->line('win-lose-subtitle'); ?></span></h3>
        <ul>
            <?php
        ...
        <a class="reload-game" href="<?php echo WEBSITE_URL ?>"><h3
                class="big white-text"><?php echo $this->lang->line('end-again'); ?></h3></a>
    </div>
    <script>
