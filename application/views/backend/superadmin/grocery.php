        ...
        <div class="full-width">
            <ul>
                ...
                <li>
                    ...
                    <fieldset class="left">
                        <input type="text" name="en_name" value="<?php echo @$grocery->en_name;?>" required="" class="field-box" placeholder="English Name"/>
                        <input type="text" name="fr_name" value="<?php echo @$grocery->fr_name;?>" required="" class="field-box" placeholder="French name"/>
                    </fieldset>
                </li>
                <li>
        ...
        <div class="col2" style="width:400px; padding-right:10px;">
            <ul>
                <li>
                    ...
                    <input type="button" class="button-box upload" id="icon" value="<?php if(isset($grocery->general_icon)){echo 'Change';}else{echo 'Add';}?> Icon"/>
                </li>                
            </ul>
        </div>
        <div class="col2">
                        ...
                        <div class="option-content <?php echo $class;?>">
                            <ul>
                                <li>
                                    ...
                                    <input type="button" class="button-box upload" id="icon-<?php echo $i?>" value="<?php if(isset($option->icon)){echo 'Change';}else{echo 'Add';}?> Icon"/>
                                </li>
                                <li>
                                    <label class="full-width">Option Description</label>
                                    <input type="text" name="en_answer_desc-<?php echo $i; ?>"  value="<?php echo @$option->en_name;?>" class="field-box full-width required" placeholder="English Description"/>
                                    <input type="text" name="fr_answer_desc-<?php echo $i; ?>"  value="<?php echo @$option->fr_name;?>" class="field-box full-width required" placeholder="French Description"/>
                                </li>
                                <li>
                                    <label class="full-width">Option Results</label>
                                    <textarea style="min-height: 50px;" name="en_answer_result-<?php echo $i; ?>" class="field-box full-width required" placeholder="English Results"><?php echo @$option->en_content;?></textarea>
                                    <textarea style="min-height: 50px;" name="fr_answer_result-<?php echo $i; ?>" class="field-box full-width required" placeholder="French Results"><?php echo @$option->fr_content;?></textarea>
                                </li>
                                <li>
