    ...
    <ul id="question-content">
        ...
        <li class="<?php echo $class; if($question->parent == 0){echo ' need-edited';}?>">
            ...
            <div class="options">
                ...
                <a href="<?php echo WEBSITE_URL.'admin/questions/delete/'.$question->id; ?>" class="button-box delete">Reset</a>
                <?php }  ?>
            </div>
        </li>
        <?php
...
<div class="export-file">
    <a href="<?php echo WEBSITE_URL.'admin/generate_excel'; ?>" title="Export Question"><i class="fa fa-save"></i>Export Questions</a>
</div>
<div class="pages"><h4>Page:</h4>
    <ul>
        ...
        ?>
        <li><a href="<?php echo WEBSITE_URL.'admin/questions/page/current/'.$i; ?>" class="button-box page <?php echo $current; ?>"><?php echo $i ?></a></li>
        <?php
        } ?>
    </ul>
</div>
